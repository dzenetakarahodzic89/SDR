...
public class SpotifyAlbumsTracks {
    ...
    private String href;
    @JsonProperty("items")
    private List<SpotifyAlbumsTrackItem> items = new ArrayList<SpotifyAlbumsTrackItem>();
    @JsonProperty("limit")
    ...
    public SpotifyAlbumsTracks withHref(String href) {
        this.href = href;
        return this;
    }

    @JsonProperty("items")
    public List<SpotifyAlbumsTrackItem> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<SpotifyAlbumsTrackItem> items) {
        this.items = items;
    }

    public SpotifyAlbumsTracks withItems(List<SpotifyAlbumsTrackItem> items) {
        this.items = items;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withNext(Object next) {
        this.next = next;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withPrevious(Object previous) {
        this.previous = previous;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public SpotifyAlbumsTracks withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyAlbumsTracks.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyAlbumsTracks) == false) {
            return false;
        }
        SpotifyAlbumsTracks rhs = ((SpotifyAlbumsTracks) other);
