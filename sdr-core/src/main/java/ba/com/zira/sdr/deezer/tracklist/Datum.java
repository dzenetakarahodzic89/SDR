...
public class Datum {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((this.readable == rhs.readable)||((this.readable!= null)&&this.readable.equals(rhs.readable)))&&((this.preview == rhs.preview)||((this.preview!= null)&&this.preview.equals(rhs.preview))))&&((this.artist == rhs.artist)||((this.artist!= null)&&this.artist.equals(rhs.artist))))&&((this.album == rhs.album)||((this.album!= null)&&this.album.equals(rhs.album))))&&((this.explicitContentLyrics == rhs.explicitContentLyrics)||((this.explicitContentLyrics!= null)&&this.explicitContentLyrics.equals(rhs.explicitContentLyrics))))&&((this.link == rhs.link)||((this.link!= null)&&this.link.equals(rhs.link))))&&((this.md5Image == rhs.md5Image)||((this.md5Image!= null)&&this.md5Image.equals(rhs.md5Image))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.duration == rhs.duration)||((this.duration!= null)&&this.duration.equals(rhs.duration))))&&((this.titleVersion == rhs.titleVersion)||((this.titleVersion!= null)&&this.titleVersion.equals(rhs.titleVersion))))&&((this.rank == rhs.rank)||((this.rank!= null)&&this.rank.equals(rhs.rank))))&&((this.titleShort == rhs.titleShort)||((this.titleShort!= null)&&this.titleShort.equals(rhs.titleShort))))&&((this.explicitLyrics == rhs.explicitLyrics)||((this.explicitLyrics!= null)&&this.explicitLyrics.equals(rhs.explicitLyrics))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.contributors == rhs.contributors)||((this.contributors!= null)&&this.contributors.equals(rhs.contributors))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.explicitContentCover == rhs.explicitContentCover)||((this.explicitContentCover!= null)&&this.explicitContentCover.equals(rhs.explicitContentCover))));
    }
