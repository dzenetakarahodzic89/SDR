...
public class SpotifyAlbums {
    ...
    private String href;
    @JsonProperty("items")
    private List<SpotifyAlbumItem> items = new ArrayList<SpotifyAlbumItem>();
    @JsonProperty("limit")
    ...
    public SpotifyAlbums withHref(String href) {
        this.href = href;
        return this;
    }

    @JsonProperty("items")
    public List<SpotifyAlbumItem> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<SpotifyAlbumItem> items) {
        this.items = items;
    }

    public SpotifyAlbums withItems(List<SpotifyAlbumItem> items) {
        this.items = items;
        return this;
    }
    ...
    public SpotifyAlbums withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SpotifyAlbums withNext(String next) {
        this.next = next;
        return this;
    }
    ...
    public SpotifyAlbums withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public SpotifyAlbums withPrevious(Object previous) {
        this.previous = previous;
        return this;
    }
    ...
    public SpotifyAlbums withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public SpotifyAlbums withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyAlbums.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyAlbums) == false) {
            return false;
        }
        SpotifyAlbums rhs = ((SpotifyAlbums) other);
