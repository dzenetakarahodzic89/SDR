...
public interface AudioDBIntegrationMapper {
    ...
    void updateEntity(AudioDBIntegrationUpdate audioDBIntegration, @MappingTarget AudioDBIntegrationEntity audioDBIntegration)
     */
    //@Mapping(source = "name", target = "name")
    void updateEntity(AudioDBIntegrationUpdateRequest audioDBIntegrationUpdateRequest, @MappingTarget AudioDBIntegrationEntity audioDBIntegrationEntity);
