...
public class SpotifyArtists {
    ...
    private String href;
    @JsonProperty("items")
    private List<SpotifyArtistItem> items = new ArrayList<SpotifyArtistItem>();
    @JsonProperty("limit")
    ...
    public SpotifyArtists withHref(String href) {
        this.href = href;
        return this;
    }

    @JsonProperty("items")
    public List<SpotifyArtistItem> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<SpotifyArtistItem> items) {
        this.items = items;
    }

    public SpotifyArtists withItems(List<SpotifyArtistItem> items) {
        this.items = items;
        return this;
    }
    ...
    public SpotifyArtists withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SpotifyArtists withNext(Object next) {
        this.next = next;
        return this;
    }
    ...
    public SpotifyArtists withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public SpotifyArtists withPrevious(Object previous) {
        this.previous = previous;
        return this;
    }
    ...
    public SpotifyArtists withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public SpotifyArtists withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyArtists.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyArtists) == false) {
            return false;
        }
        SpotifyArtists rhs = ((SpotifyArtists) other);
