...
public class Datum {
    ...
    public String toString() {
        ...
        sb.append("nbAlbum");
        sb.append('=');
        sb.append(((this.nbAlbum == null)?"<null>":this.nbAlbum));
        sb.append(',');
        sb.append("nbFan");
        sb.append('=');
        sb.append(((this.nbFan == null)?"<null>":this.nbFan));
        sb.append(',');
        sb.append("radio");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((this.tracklist == rhs.tracklist)||((this.tracklist!= null)&&this.tracklist.equals(rhs.tracklist)))&&((this.nbFan == rhs.nbFan)||((this.nbFan!= null)&&this.nbFan.equals(rhs.nbFan))))&&((this.link == rhs.link)||((this.link!= null)&&this.link.equals(rhs.link))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.picture == rhs.picture)||((this.picture!= null)&&this.picture.equals(rhs.picture))))&&((this.radio == rhs.radio)||((this.radio!= null)&&this.radio.equals(rhs.radio))))&&((this.pictureBig == rhs.pictureBig)||((this.pictureBig!= null)&&this.pictureBig.equals(rhs.pictureBig))))&&((this.pictureSmall == rhs.pictureSmall)||((this.pictureSmall!= null)&&this.pictureSmall.equals(rhs.pictureSmall))))&&((this.nbAlbum == rhs.nbAlbum)||((this.nbAlbum!= null)&&this.nbAlbum.equals(rhs.nbAlbum))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.pictureMedium == rhs.pictureMedium)||((this.pictureMedium!= null)&&this.pictureMedium.equals(rhs.pictureMedium))))&&((this.pictureXl == rhs.pictureXl)||((this.pictureXl!= null)&&this.pictureXl.equals(rhs.pictureXl))));
    }
