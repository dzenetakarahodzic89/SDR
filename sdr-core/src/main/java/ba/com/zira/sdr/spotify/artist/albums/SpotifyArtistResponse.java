...
public class SpotifyArtistResponse {
    ...
    public SpotifyArtistResponse withExternalUrls(ExternalUrls externalUrls) {
        this.externalUrls = externalUrls;
        return this;
    }
    ...
    public SpotifyArtistResponse withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public SpotifyArtistResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SpotifyArtistResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SpotifyArtistResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public SpotifyArtistResponse withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public SpotifyArtistResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyArtistResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyArtistResponse) == false) {
            return false;
        }
        SpotifyArtistResponse rhs = ((SpotifyArtistResponse) other);
