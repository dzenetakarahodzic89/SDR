...
public class SpotifyTrackItem {
    ...
    public SpotifyTrackItem withAlbum(Album album) {
        this.album = album;
        return this;
    }
    ...
    public SpotifyTrackItem withArtists(List<Artist__1> artists) {
        this.artists = artists;
        return this;
    }
    ...
    public SpotifyTrackItem withAvailableMarkets(List<String> availableMarkets) {
        this.availableMarkets = availableMarkets;
        return this;
    }
    ...
    public SpotifyTrackItem withDiscNumber(Integer discNumber) {
        this.discNumber = discNumber;
        return this;
    }
    ...
    public SpotifyTrackItem withDurationMs(Integer durationMs) {
        this.durationMs = durationMs;
        return this;
    }
    ...
    public SpotifyTrackItem withExplicit(Boolean explicit) {
        this.explicit = explicit;
        return this;
    }
    ...
    public SpotifyTrackItem withExternalIds(ExternalIds externalIds) {
        this.externalIds = externalIds;
        return this;
    }
    ...
    public SpotifyTrackItem withExternalUrls(ExternalUrls__3 externalUrls) {
        this.externalUrls = externalUrls;
        return this;
    }
    ...
    public SpotifyTrackItem withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public SpotifyTrackItem withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SpotifyTrackItem withIsLocal(Boolean isLocal) {
        this.isLocal = isLocal;
        return this;
    }
    ...
    public SpotifyTrackItem withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SpotifyTrackItem withPopularity(Integer popularity) {
        this.popularity = popularity;
        return this;
    }
    ...
    public SpotifyTrackItem withPreviewUrl(String previewUrl) {
        this.previewUrl = previewUrl;
        return this;
    }
    ...
    public SpotifyTrackItem withTrackNumber(Integer trackNumber) {
        this.trackNumber = trackNumber;
        return this;
    }
    ...
    public SpotifyTrackItem withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public SpotifyTrackItem withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public SpotifyTrackItem withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyTrackItem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("album");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyTrackItem) == false) {
            return false;
        }
        SpotifyTrackItem rhs = ((SpotifyTrackItem) other);
