...
public class InstrumentServiceImpl implements InstrumentService {
    ...
    @Override
    public ListPayloadResponse<InstrumentSearchResponse> instrumentSearch(final EntityRequest<InstrumentSearchRequest> request) {
        var req = request.getEntity();
        List<InstrumentSearchResponse> instruments = instrumentDAO.search(req.getName(), req.getSortBy(), req.getPage(), req.getPageSize());

        lookupService.lookupCoverImage(instruments, InstrumentSearchResponse::getId, ObjectType.INSTRUMENT.getValue(),
