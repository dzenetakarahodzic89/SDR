...
public class SpotifyGetArtistsAlbums {

    @JsonProperty("href")
    private String href;
    @JsonProperty("items")
    private List<SpotifyArtistsAlbumItem> items = new ArrayList<SpotifyArtistsAlbumItem>();
    @JsonProperty("limit")
    ...
    public SpotifyGetArtistsAlbums withHref(String href) {
        this.href = href;
        return this;
    }

    @JsonProperty("items")
    public List<SpotifyArtistsAlbumItem> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<SpotifyArtistsAlbumItem> items) {
        this.items = items;
    }

    public SpotifyGetArtistsAlbums withItems(List<SpotifyArtistsAlbumItem> items) {
        this.items = items;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withNext(String next) {
        this.next = next;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withPrevious(Object previous) {
        this.previous = previous;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public SpotifyGetArtistsAlbums withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SpotifyGetArtistsAlbums.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotifyGetArtistsAlbums) == false) {
            return false;
        }
        SpotifyGetArtistsAlbums rhs = ((SpotifyGetArtistsAlbums) other);
