...
public class InstrumentSearchResponse implements Serializable {
	...
	public InstrumentSearchResponse(Long id, String name, String type, String information, LocalDateTime created,
			String createdBy, LocalDateTime modified, String modifiedBy, String status, String outlineText) {
		super();
		this.id = id;
		this.type = type;
		this.name = name;
