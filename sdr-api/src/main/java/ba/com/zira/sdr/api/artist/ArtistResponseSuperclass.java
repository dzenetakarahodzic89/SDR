...
public class ArtistResponseSuperclass implements Serializable {
    ...
    public ArtistResponseSuperclass(final Long id, final String name, final LocalDateTime created, final String createdBy,
    ...
    public ArtistResponseSuperclass(String name, LocalDateTime dateOfBirth, LocalDateTime dateOfDeath, String information, String status,
    ...
    public ArtistResponseSuperclass(Long id, String name, LocalDateTime dateOfBirth, LocalDateTime dateOfDeath, String information,
            String status, String surname, String type) {
        this.id = id;
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.dateOfDeath = dateOfDeath;
