...
/**
 * * Methods used to manipulate {@link SampleModel} data. <br> List of APIs implemented in this class with links:
 * <ul>
 * <li>{@link #find}</li>
 * <li>{@link #create}</li>
 * <li>{@link #update}</li>
...
public interface SampleService {
     ...
     */
    PagedPayloadResponse<SampleModel> find(final FilterRequest request) throws ApiException;
