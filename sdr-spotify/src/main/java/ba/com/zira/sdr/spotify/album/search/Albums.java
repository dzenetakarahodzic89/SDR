...
public class Albums {
    ...
    private String href;
    @JsonProperty("items")
    private List<AlbumItem> items = new ArrayList<AlbumItem>();
    @JsonProperty("limit")
    ...
    public Albums withItems(List<AlbumItem> items) {
        this.items = items;
        return this;
    }
    ...
    public Albums withPrevious(Object previous) {
        this.previous = previous;
        return this;
    }
    ...
    public Albums withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Albums) == false) {
            return false;
        }
        Albums rhs = ((Albums) other);
        return (((((((((this.next == rhs.next) || ((this.next != null) && this.next.equals(rhs.next)))
                ...
                && ((this.previous == rhs.previous) || ((this.previous != null) && this.previous.equals(rhs.previous))))
                && ((this.limit == rhs.limit) || ((this.limit != null) && this.limit.equals(rhs.limit))))
