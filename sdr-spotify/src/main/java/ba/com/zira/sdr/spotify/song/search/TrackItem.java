...
public class TrackItem {
    ...
    public TrackItem withAlbum(Album album) {
        this.album = album;
        return this;
    }
    ...
    public TrackItem withArtists(List<Artist__1> artists) {
        this.artists = artists;
        return this;
    }
    ...
    public TrackItem withAvailableMarkets(List<String> availableMarkets) {
        this.availableMarkets = availableMarkets;
        return this;
    }
    ...
    public TrackItem withDiscNumber(Integer discNumber) {
        this.discNumber = discNumber;
        return this;
    }
    ...
    public TrackItem withDurationMs(Integer durationMs) {
        this.durationMs = durationMs;
        return this;
    }
    ...
    public TrackItem withExplicit(Boolean explicit) {
        this.explicit = explicit;
        return this;
    }
    ...
    public TrackItem withExternalIds(ExternalIds externalIds) {
        this.externalIds = externalIds;
        return this;
    }
    ...
    public TrackItem withExternalUrls(ExternalUrls__3 externalUrls) {
        this.externalUrls = externalUrls;
        return this;
    }
    ...
    public TrackItem withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public TrackItem withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TrackItem withIsLocal(Boolean isLocal) {
        this.isLocal = isLocal;
        return this;
    }
    ...
    public TrackItem withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public TrackItem withPopularity(Integer popularity) {
        this.popularity = popularity;
        return this;
    }
    ...
    public TrackItem withPreviewUrl(String previewUrl) {
        this.previewUrl = previewUrl;
        return this;
    }
    ...
    public TrackItem withTrackNumber(Integer trackNumber) {
        this.trackNumber = trackNumber;
        return this;
    }
    ...
    public TrackItem withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public TrackItem withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public TrackItem withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TrackItem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("album");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrackItem) == false) {
            return false;
        }
        TrackItem rhs = ((TrackItem) other);
