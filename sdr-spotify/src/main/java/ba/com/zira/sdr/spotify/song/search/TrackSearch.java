...
public class TrackSearch {
    ...
    public TrackSearch withTracks(Tracks tracks) {
        this.tracks = tracks;
        return this;
    }
    ...
    public TrackSearch withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TrackSearch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tracks");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrackSearch) == false) {
            return false;
        }
        TrackSearch rhs = ((TrackSearch) other);
